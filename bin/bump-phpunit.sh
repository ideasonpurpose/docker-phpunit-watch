...
# style helpers
RESET="\033[0m" BOLD="\033[1m" RED="\033[31m" GREEN="\033[32m" GOLD="\033[33m"
BLUE="\033[34m" MAGENTA="\033[35m" CYAN="\033[36m"

PHPUNIT_LATEST=$(jq -r 'to_entries[].value' /app/phpunit-version.json)

echo -e "✏️   Updating ${GOLD}Dockerfile${RESET} to
${CYAN}phpunit-${PHPUNIT_LATEST}.phar${RESET}" sed -i
"s/phpunit.de\/phpunit-.*phar/phpunit.de\/phpunit-${PHPUNIT_LATEST}.phar/"
/app/Dockerfile

echo -e "✏️   Updating ${GOLD}README.md${RESET} to
${CYAN}v${PHPUNIT_LATEST}${RESET}" sed -E -i "s/^<\!-- PHPUNIT_VERSION -->-
PHPUnit.+$/<\!-- PHPUNIT_VERSION -->- PHPUnit ${PHPUNIT_LATEST}/" /app/README.md
